          ...
          <div className="flex flex-col justify-center px-3 py-3 flex-1">
            <div className="grid items-stretch" style={{ gridTemplateColumns: '80px 1fr' }}>
              ...
              {(extraDirection || extraQuality) && <>
                <span className="flex items-center whitespace-nowrap text-[9px] uppercase tracking-widest text-muted-foreground py-2.5 border-t border-border/45">PLUS 1 MIN 1</span>
