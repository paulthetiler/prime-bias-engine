...
// below is the first ruleset explicitly audited formula-by-formula against the
// canonical uploaded "Prime Bias.xlsx" workbook. Any future maths change must
// receive another version bump so performance data from different rulesets can
// never be mixed.

import { LEGACY_ENGINE_VERSION } from './tradeCompat';

export const CURRENT_ENGINE_VERSION = 'prime-bias-excel-canonical-v2';
