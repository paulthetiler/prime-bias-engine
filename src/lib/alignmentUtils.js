...
export function alignmentBg(label) {
  if (label === 'HIGH') return 'bg-emerald-500/10 border-emerald-500/30 text-emerald-300';
  if (label === 'MEDIUM') return 'bg-yellow-500/10 border-yellow-500/30 text-yellow-300';
